https://teachablemachine.withgoogle.com/models/8JbY8e5eG/
Webcam.set({
    width:350,
    height:300,
    image_format:'png',
...
classifier=
ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/8JbY8e5eG/model.json',modelLoaded);
